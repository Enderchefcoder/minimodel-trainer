...
def main(argv: list[str] | None = None) -> int:
    ...
    p.add_argument("--start-elo", type=float, default=2800.0)
    p.add_argument("--probe-only", action="store_true")
    p.add_argument("--keep-trails", type=int, default=900_000)
    p.add_argument("--bfs-nodes", type=int, default=40_000)
    p.add_argument("--bfs-plies", type=int, default=8)
    p.add_argument("--bfs-branch", type=int, default=12)
